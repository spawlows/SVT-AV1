...
#define ADD_VECS_16bit_SAD(dst, a, b)                 \
    *(__m128i *) dst = _mm_add_epi32(                 \
        _mm_loadu_si128((__m128i const *) a),         \
        _mm_loadu_si128((__m128i const *) b));
...
#define SEARCH_CALC_BEST_16BIT_SAD      SEARCH_CALC_BEST
    ...
    *(__m128i *) sad_32x16[0] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_16x32[0] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_16x32[1] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_32x16[1] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad16x16[4], p_sad16x16[5]);
    LOAD_16BIT_PACK_2(pack[2], p_sad16x16[6], p_sad16x16[7]);
    *(__m128i *) sad_32x16[2] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_16x32[2] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_16x32[3] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_32x16[3] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad16x16[8], p_sad16x16[9]);
    LOAD_16BIT_PACK_2(pack[2], p_sad16x16[10], p_sad16x16[11]);
    *(__m128i *) sad_32x16[4] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_16x32[4] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_16x32[5] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_32x16[5] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad16x16[12], p_sad16x16[13]);
    LOAD_16BIT_PACK_2(pack[2], p_sad16x16[14], p_sad16x16[15]);
    *(__m128i *) sad_32x16[6] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_16x32[6] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_16x32[7] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_32x16[7] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[0], p_sad8x8[1]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[2], p_sad8x8[3]);
    *(__m128i *) sad_16x8[0] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[0] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[1] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[1] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[4], p_sad8x8[5]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[6], p_sad8x8[7]);
    *(__m128i *) sad_16x8[2] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[2] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[3] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[3] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[8], p_sad8x8[9]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[10], p_sad8x8[11]);
    *(__m128i *) sad_16x8[4] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[4] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[5] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[5] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[12], p_sad8x8[13]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[14], p_sad8x8[15]);
    *(__m128i *) sad_16x8[6] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[6] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[7] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[7] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[16], p_sad8x8[17]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[18], p_sad8x8[19]);
    *(__m128i *) sad_16x8[8] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[8] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[9] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[9] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[20], p_sad8x8[21]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[22], p_sad8x8[23]);
    *(__m128i *) sad_16x8[10] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[10] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[11] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[11] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[24], p_sad8x8[25]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[26], p_sad8x8[27]);
    *(__m128i *) sad_16x8[12] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[12] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[13] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[13] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[28], p_sad8x8[29]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[30], p_sad8x8[31]);
    *(__m128i *) sad_16x8[14] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[14] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[15] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[15] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[32], p_sad8x8[33]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[34], p_sad8x8[35]);
    *(__m128i *) sad_16x8[16] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[16] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[17] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[17] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[36], p_sad8x8[37]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[38], p_sad8x8[39]);
    *(__m128i *) sad_16x8[18] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[18] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[19] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[19] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[40], p_sad8x8[41]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[42], p_sad8x8[43]);
    *(__m128i *) sad_16x8[20] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[20] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[21] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[21] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[44], p_sad8x8[45]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[46], p_sad8x8[47]);
    *(__m128i *) sad_16x8[22] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[22] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[23] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[23] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[48], p_sad8x8[49]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[50], p_sad8x8[51]);
    *(__m128i *) sad_16x8[24] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[24] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[25] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[25] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[52], p_sad8x8[53]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[54], p_sad8x8[55]);
    *(__m128i *) sad_16x8[26] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[26] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[27] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[27] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[56], p_sad8x8[57]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[58], p_sad8x8[59]);
    *(__m128i *) sad_16x8[28] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[28] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[29] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[29] = _mm_add_epi32(pack[2], pack[3]);
    LOAD_16BIT_PACK_2(pack[0], p_sad8x8[60], p_sad8x8[61]);
    LOAD_16BIT_PACK_2(pack[2], p_sad8x8[62], p_sad8x8[63]);
    *(__m128i *) sad_16x8[30] = _mm_add_epi32(pack[0], pack[1]);
    *(__m128i *) sad_8x16[30] = _mm_add_epi32(pack[0], pack[2]);
    *(__m128i *) sad_8x16[31] = _mm_add_epi32(pack[1], pack[3]);
    *(__m128i *) sad_16x8[31] = _mm_add_epi32(pack[2], pack[3]);
