...
void setup_common_rtcd_internal(CPU_FLAGS flags) {
    ...
    if (flags & HAS_SSE4_1) svt_av1_inv_txfm2d_add_64x64 = svt_av1_inv_txfm2d_add_64x64_sse4_1;
...
#endif
        SET_AVX2(
            svt_av1_highbd_warp_affine, svt_av1_highbd_warp_affine_c, svt_av1_highbd_warp_affine_avx2);
